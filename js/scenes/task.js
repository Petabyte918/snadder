var Task = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        this.add.image(500,820,'popupBG0').setScale(0.6,1.2);
        ...
        for(let i = 0,j=0,k=0;i<6;i++){
            ...
            k++;
            this.add.image(100+ (k*260),500+j,'popupBG4').setScale(0.75);
            // this.add.image(100+ (k*200),400+j,'lock').setScale(0.7);
        }
        ...
        this.add.dynamicBitmapText(280,450,'green','This is my first question \nanswer it or die',35);
